...
import { PackProductService } from "../services/pack-product.service";
import { HttpResponse } from "../../shared/response/http.status.response";
import { DeleteResult, UpdateResult } from "typeorm";


export class PackProductController{
    constructor(
      private readonly userService:PackProductService=new PackProductService(),
